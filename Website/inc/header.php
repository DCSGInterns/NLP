...
<div id="header_wrapper">
	<div id="header" class="container">
		<div id="header_links" class="row">
            ...
            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1" id="search"><a href="">Heat Map</a></div>
            ...
            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1" id="about">
                <a href="" data-toggle="modal" data-target="#myModal"><img src="img/qs.png" alt="Help" ></a>
            </div>
		</div>
	</div>
</div>